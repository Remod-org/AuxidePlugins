...
public class AuxideBots : RustScript
{
    #region vars
    private readonly RustScript Kits;
    ...
    public static AuxideBots Instance;
    ...
    private void OnPlayerInput(BasePlayer player, InputState input)
    {
        ...
        if (Physics.Raycast(player.eyes.HeadRay(), out hit, 3f, playerMask))
        {
            ...
            //scripts.Broadcast("OnUseNPC", hp.player, player);
            SaveData();
        }
    }
    ...
    private void NPCKitSelectGUI(BasePlayer player, string profile)
    {
        ...
        //Kits?.Broadcast("GetKitNames", kits);
    ...
    public class MonBotInfo
    {
        ...
        public System.Timers.Timer pausetimer;
